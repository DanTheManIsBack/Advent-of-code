inp = """gtlbhbjgkrb5sixfivefivetwosix
...
for j in range(len(arr)):
    for k in range(len(arr[j])):
        if ord(arr[j][k]) >= 49 and ord(arr[j][k]) <= 57:
            num.append(arr[j][k])
        if arr[j][k] != "0":
            if arr[j][k] == "o" and arr[j][k+1] == "n" and arr[j][k+2] == "e":
                num.append("1")
            elif arr[j][k] == "t" and arr[j][k+1] == "w" and arr[j][k+2] == "o":
                num.append("2")
            elif arr[j][k] == "t" and arr[j][k+1] == "h" and arr[j][k+2] == "r" and arr[j][k+3] == "e" and arr[j][k+4] == "e":
                num.append("3")
            elif arr[j][k] == "f" and arr[j][k+1] == "o" and arr[j][k+2] == "u" and arr[j][k+3] == "r":
                num.append("4")
            elif arr[j][k] == "f" and arr[j][k+1] == "i" and arr[j][k+2] == "v" and arr[j][k+3] == "e":
                num.append("5")
            elif arr[j][k] == "s" and arr[j][k+1] == "i" and arr[j][k+2] == "x":
                num.append("6")
            elif arr[j][k] == "s" and arr[j][k+1] == "e" and arr[j][k+2] == "v" and arr[j][k+3] == "e" and arr[j][k+4] == "n":
                num.append("7")
            elif arr[j][k] == "e" and arr[j][k+1] == "i" and arr[j][k+2] == "g" and arr[j][k+3] == "h" and arr[j][k+4] == "t":
                num.append("8")
            elif arr[j][k] == "n" and arr[j][k+1] == "i" and arr[j][k+2] == "n" and arr[j][k+3] == "e":
                num.append("9")
        else:
            pass
